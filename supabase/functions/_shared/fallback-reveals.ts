...
export const allYesFallback: FallbackDescription = {
  ...
  observation: "Most people lean one way. You lean in a few directions at once. That's not indecision — that's an eye still reading the room, still collecting what it likes before it narrows. Your home won't look like one style. It'll look like you put it together.",
  ctaPrompt: "See rooms other open-taste buyers loved.",
};

export const allNoFallback: FallbackDescription = {
  id: 'all-no',
  essence: "Your taste isn't in this set — which is its own kind of signal.",
...
export const flatMiddleFallback: FallbackDescription = {
  ...
  observation: "Single-result quizzes suit readers who lean hard one way. You came in differently. That's not indecision — that's aesthetic range. Your home won't look like one magazine spread. It'll look like you pulled the best pieces from a few and made them agree. Some of the best rooms come from exactly that.",
